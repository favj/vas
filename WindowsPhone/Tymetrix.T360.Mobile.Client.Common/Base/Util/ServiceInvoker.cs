        ...
        private static void GetResponseCallback(IAsyncResult asynchronousResult)
        {
            ...
            catch (WebException e)
            {
                ...
                if (e.Response != null)
                {
                    ...
                    else if (errorResponse.StatusCode == HttpStatusCode.NotFound && errorResponse.StatusDescription == string.Empty)
                    {
                        serviceResponse.ErrorDetails = new List<Error>() { new Error() { Code = T360ErrorCodes.UnableToConnectServer } };
                    }
