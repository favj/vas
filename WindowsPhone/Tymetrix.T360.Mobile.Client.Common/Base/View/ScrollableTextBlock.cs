...
namespace Tymetrix.T360.Mobile.Client.Common.Base.View
{
    public class ScrollableTextBlock : Control
    {
        ...
        public ScrollableTextBlock()
        {
            ...
            //ControlTemplate template = new ControlTemplate(typeof(ScrollViewer));
            //template.TargetType = typeof(ScrollableTextBlock);
        ...
        private int GetMaxTextSize()
        {
            ...
            // Get line count
            int lineCount = (int)(1900 / size.Height);
        ...
        private int GetMaxLineCount()
        {
            ...
            int charLineCount = (int)(this.Width / size.Width);
            // Get line count
            int lineCount = (int)(1900 / size.Height) - 5;
