...
using Tymetrix.T360.Mobile.Client.AppWP7.Invoice;
using Tymetrix.T360.Mobile.Client.Model.Invoice;
using System.Collections.Generic;

namespace Tymetrix.T360.Mobile.Client.AppWP7.Dashboard
{
    public partial class Dashboard : BasePage
    {
        ...
        private void invoiceButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Uri uri = new Uri("/Tymetrix.T360.Mobile.Client.AppWP7;component/Invoice/InvoiceListing.xaml", UriKind.Relative);
        ...
        private void logOutButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Uri uri = new Uri("/Tymetrix.T360.Mobile.Client.AppWP7;component/Base/View/LogOn.xaml", UriKind.Relative);
                this.NavigationService.Navigate(uri);
            }
        }
        ...
        {
            Uri uri = new Uri("/Tymetrix.T360.Mobile.Client.AppWP7;component/Support/Support.xaml", UriKind.Relative);
            this.NavigationService.Navigate(uri);
        }

        private void faqButton_Click(object sender, RoutedEventArgs e)
        {
            Uri uri = new Uri("/Tymetrix.T360.Mobile.Client.AppWP7;component/Faq/Faq.xaml", UriKind.Relative);
            this.NavigationService.Navigate(uri);
        }
        ...
        private void settingsButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Uri uri = new Uri("/Tymetrix.T360.Mobile.Client.AppWP7;component/Settings/Settings.xaml", UriKind.Relative);
            this.NavigationService.Navigate(uri);
        }
    }
}