...
namespace Tymetrix.T360.Mobile.Client.AppWP8.Invoice
{
    public partial class InvoiceListing : BasePage
    {
        ...
        private void GetLineItemList(object sender, ServiceEventArgs args)
        {
            ...
            if (result.Status)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    ...
                    Uri uri = new Uri("/Tymetrix.T360.Mobile.Client.AppWP8;component/Invoice/InvoiceCommonDetails.xaml", UriKind.Relative);
                    this.NavigationService.Navigate(uri);
        ...
        private List<LineItem> LineItemList { get; set; }
